# Task: Implement [EPIC_TO_IMPLEMENT] From Scrum Plan, Test, and Document
...
1. Open and fully read `[@docs/scrum/Epic-[N].md]`.
2. Find the section for **[EPIC_TO_IMPLEMENT]**. Quote or restate its full scope/requirements in your own words before continuing — including acceptance criteria, edge cases, and any explicitly out-of-scope items mentioned in the plan.
...
2. **[EPIC_TO_IMPLEMENT] Plan Summary**
