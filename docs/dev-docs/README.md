...
| **[Budget Management & Burn Index Dashboard](./features/budget-burn-index.md)**                            | [Epic-05](../../scrum/Epic-05.md) | Analytical command center, section burn cards, 4-quadrant Budget Control Matrix, and asynchronous monthly rollups.                                 |
