...
test('manager can view all 5 multi-chart grid widgets on dashboard with proper interaction', function () {
    ...
    visit('/login')
        ...
        ->assertPresent('[data-test="overtime-leaderboard-podium"]')
        ->assertPresent('[data-test="overtime-leaderboard-top3"]')
        ->assertPresent('[data-test="overtime-leaderboard-rank-1"]')
